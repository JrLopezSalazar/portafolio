...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = "service_r08bq2h";
    const templateId = "template_hu6xia5";
    const apikey = "zdgDDK25SavDsfVnC";
  ...
  return (
    ...
    <div className="bg-[#3C4742]   mx-auto md:px-6 px-3">
      <section className="pt-10">
        <div className="flex flex-wrap">
          <div className="mb-10 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
            <h2 className="text-white mb-6 text-3xl md:text-6xl font-Poppins font-semibold justify-center  flex">Contactame</h2>
            <p className="mb-6 text-slate-400 md:text-xl dark:text-neutral-300">
              ¡Hola! Estoy emocionado de que estés interesado en ponerse en
              contacto. Ya sea que tengas una pregunta sobre mi trabajo, una
              propuesta de colaboración estaré encantado de leerte.
            </p>
            <p className="mb-2 text-slate-400 md:text-xl dark:text-neutral-300">
              Gracias a la magia de internet, ¡puedo trabajar contigo sin
              importar la distancia!
            </p>
            <p className="mb-2 text-slate-400 md:text-xl dark:text-neutral-200 ">
              contacto@juniorlopez.dev
            </p>
            {/* <p class="mb-2 text-neutral-500 dark:text-neutral-300">
          info@gmail.com
        </p> */}
            <li className=" list-none mb-6 md:flex items-center justify-center gap-7 md:mt-20 flex">
              <a
              title="linkedin junior lopez"
                className="mb-10"
                href="https://www.linkedin.com/in/junior-lopez-developer/"
                target="_blank"
              >
                <img
                  className="h-[66px] "
              ...
              <a
                className="mb-10"
                title="curriculum vitaejunior lopez"
                href="https://drive.google.com/file/d/1esvLOJa99YF8uM6ni4ds1r2xxZPpbdBx/view?usp=drive_link"
                target="_blank"
              >
                <img
                  className="h-14"
          ...
          <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6 mt-4">
            <form>
              ...
              transition duration-150 ease-in-out hover:bg-yellow-400/20
                cursor-pointer
              focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(#fbbf24),0_4px_18px_0_rgba(59,113,202,0.2)]
